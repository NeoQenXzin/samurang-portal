 ...
 */
final class Version20240926190142 extends AbstractMigration
{
    ...
    public function up(Schema $schema): void
    {
        ...
        $this->addSql('CREATE TABLE instructor (id INT NOT NULL, grade_id INT NOT NULL, dojang_id INT DEFAULT NULL, firstname VARCHAR(70) NOT NULL, lastname VARCHAR(70) NOT NULL, birthdate TIMESTAMP(0) WITHOUT TIME ZONE NOT NULL, adress VARCHAR(255) NOT NULL, sexe VARCHAR(25) NOT NULL, tel VARCHAR(25) DEFAULT NULL, mail VARCHAR(70) NOT NULL, passport VARCHAR(25) DEFAULT NULL, roles JSON NOT NULL, password VARCHAR(255) NOT NULL, PRIMARY KEY(id))');
        ...
        $this->addSql('CREATE TABLE student (id INT NOT NULL, grade_id INT NOT NULL, dojang_id INT DEFAULT NULL, instructor_id INT DEFAULT NULL, firstname VARCHAR(70) NOT NULL, lastname VARCHAR(70) NOT NULL, birthdate TIMESTAMP(0) WITHOUT TIME ZONE NOT NULL, adress VARCHAR(255) NOT NULL, sexe VARCHAR(25) NOT NULL, tel VARCHAR(25) DEFAULT NULL, mail VARCHAR(70) NOT NULL, passport VARCHAR(25) DEFAULT NULL, roles JSON NOT NULL, password VARCHAR(255) NOT NULL, PRIMARY KEY(id))');
